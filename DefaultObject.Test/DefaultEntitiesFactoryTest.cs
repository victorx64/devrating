...
{
    public sealed class DefaultEntitiesFactoryTest
    {
        [Fact]
        ...
        public void InsertsNewAuthorNewRatingWhenDeleteManyNewVictims()
        {
            ...
            new DefaultEntitiesFactory(
                ...
                .InsertRatings(author.Email(), new[] {deletion1, deletion2},
                    new FakeWork(0u, author));
        ...
        public void InsertsNewAuthorNewRatingWhenDeleteOneOldVictim()
        {
            ...
            new DefaultEntitiesFactory(
                ...
                .InsertRatings(author.Email(), new[] {deletion},
                    new FakeWork(0u, author, new NullRating()));
