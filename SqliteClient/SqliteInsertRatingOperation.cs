...
namespace DevRating.SqliteClient
{
    internal sealed class SqliteInsertRatingOperation : InsertRatingOperation
    {
        ...
        public Rating Insert(double value, Envelope deletions, Id rating, Id work, Id author)
        {
            ...
            command.Parameters.Add(new SqliteParameter("@PreviousRatingId", SqliteType.Integer) {Value = rating.Value()});
