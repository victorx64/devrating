...
+",
                new FakeFileBlames(
                    new[]
                    {
                            new GitBlame("Victim", 0u, 100u, new FakeDiffSizes(1000u), string.Empty),
                    }
                )
            ).Items());
    }
...
+  'version': '0.4.39',",
                    new FakeFileBlames(
                        new[]
                        {
                                new GitBlame("Victim1", 2u, 1u, new FakeDiffSizes(1000u), string.Empty),
                                new GitBlame("Victim2", 4u, 1u, new FakeDiffSizes(1000u), string.Empty),
                        }
                    )
                )
                .Items()
...
+  'version': '0.4.39',",
                    new FakeFileBlames(
                        new[]
                        {
                                new GitBlame("Victim1", 2u, 3u, new FakeDiffSizes(1000u), string.Empty),
                        }
                    )
                )
                .Items()
